...
add_private_key_to_dict(keys, KEY_PURPOSE_EQ_SUBMISSION, 'sdc-submission-encryption-sdx-private-key.pem')
add_public_key_to_dict(keys, KEY_PURPOSE_EQ_SUBMISSION, 'sdc-submission-signing-sr-public-key.pem')
